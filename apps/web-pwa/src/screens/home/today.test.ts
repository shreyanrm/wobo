...
describe('the home’s own words', () => {
  it('asks one question, and the card opens it as a sentence', () => {
    // No late hour, ever (owner's standing law). `hours.test.ts` now walks every screen rather
    // than the seven marketing directories, which is how this line was found.
