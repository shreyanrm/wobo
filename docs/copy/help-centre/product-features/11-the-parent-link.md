...
Your conversations with Wobo. Your wrong answers, one by one. A live feed of when you are online. A way to set targets for you. It is a window, not a remote control.
...
The same screen, one tap. It stops immediately and the old pages stop working. You do not have to explain why, and Wobo does not tell them you turned it off, only that the link ended.
